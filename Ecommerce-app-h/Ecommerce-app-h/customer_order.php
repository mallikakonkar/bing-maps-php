								...
								while ($row=mysqli_fetch_array($query)) {
									?>
										<div class="row">
											...
											<div class="col-md-6">
												<table>
													<tr><td>Store Name</td><td><b><?php echo $row["product_title"]; ?></b> </td></tr>
													<!-- <tr><td>Product Price</td><td><b>
														<?php 
														// echo  CURRENCY." ".$row["product_price"]; 
														?></b></td></tr> -->
													<!-- <tr><td>Quantity</td><td><b>
														<?php 
													// echo $row["qty"]; 
													?></b></td></tr>
													<tr><td>Transaction Id</td><td><b>
														<?php 
														// echo $row["trx_id"];
														 ?>
													</b></td></tr> -->
