	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">	
			<div class="navbar-header">
				...
				<a href="index.php" class="navbar-brand">Roosevelt Field</a>
			</div>
		<div class="collapse navbar-collapse" id="collapse">
			<ul class="nav navbar-nav">
				<li><a href="index.php"><span class="glyphicon glyphicon-home"></span> Home</a></li>
				<li><a href="index.php"><span class="glyphicon glyphicon-modal-window"></span> Shops</a></li>
			</ul>
						...
						<div class="panel panel-success">
							<div class="panel-heading">
								<div class="row">
									...
									<div class="col-md-3">Stores</div>
									<div class="col-md-3">Store Name</div>
									<!-- <div class="col-md-3">Price in <?php 
									// echo CURRENCY; 
									?></div> -->
								</div>
							</div>
